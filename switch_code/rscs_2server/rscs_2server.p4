...
#define RNDSERVER_SIZE_2SERVER 1
#define RND_SIZE_2SERVER 1
...
header_type sq_metadata_t {
    fields {
        ...
        counter_idx : 8;
        sq_server : 3;
        random_server1 : RNDSERVER_SIZE_2SERVER;
        random_server2 : RNDSERVER_SIZE_2SERVER;
        qlen_random1 : 32;
        qlen_random2 : 32;
        min_random_qlen : 32;
...
action act_gen_random_server1() {
    modify_field_rng_uniform(sq_md.random_server1, 0, RND_SIZE_2SERVER);
}
...
action act_gen_random_server2() {
    modify_field_rng_uniform(sq_md.random_server2, 0, RND_SIZE_2SERVER);
}
