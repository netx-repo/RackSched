...
field_list_calculation sq_hash_1 {
    input {sq_hash_field;}
    algorithm : crc16_extend;
    output_width : HASH_NUM_BASE;
}

field_list_calculation sq_reply_hash_1 {
...
action act_wrt_ht1() {
    salu_wrt_ht1.execute_stateful_alu_from_hash(sq_hash_1);
}
...
action act_read_ht1() {
    salu_read_ht1.execute_stateful_alu_from_hash(sq_hash_1);
}
...
action act_reset_ht1() {
    salu_reset_ht1.execute_stateful_alu_from_hash(sq_reply_hash_1);
}
