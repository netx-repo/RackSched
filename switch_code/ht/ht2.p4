...
field_list_calculation sq_hash_2 {
    input {sq_hash_field;}
    algorithm : crc_16_en_13757;
    output_width : HASH_NUM_BASE;
}

field_list_calculation sq_reply_hash_2 {
    input {sq_reply_hash_field;}
    algorithm : crc_16_en_13757;
    output_width : HASH_NUM_BASE;
}
...
action act_wrt_ht2() {
    salu_wrt_ht2.execute_stateful_alu_from_hash(sq_hash_2);
}
...
action act_read_ht2() {
    salu_read_ht2.execute_stateful_alu_from_hash(sq_hash_2);
}
...
action act_reset_ht2() {
    salu_reset_ht2.execute_stateful_alu_from_hash(sq_reply_hash_2);
}
