...
field_list_calculation sq_hash_3 {
    input {sq_hash_field;}
    algorithm : crc_16_genibus;
    output_width : HASH_NUM_BASE;
}

field_list_calculation sq_reply_hash_3 {
...
action act_wrt_ht3() {
    salu_wrt_ht3.execute_stateful_alu_from_hash(sq_hash_3);
}
...
action act_read_ht3() {
    salu_read_ht3.execute_stateful_alu_from_hash(sq_hash_3);
}
...
action act_reset_ht3() {
    salu_reset_ht3.execute_stateful_alu_from_hash(sq_reply_hash_3);
}
